...
import { Calendar, Footprints, Bike, Dumbbell, Scale, TrendingUp, Download } from 'lucide-react';
...
const Navigation = ({ activeSheet, setActiveSheet, activeWeek, maxWeeks, handleExportToCSV }) => {
  return (
    <div className="flex gap-2 mb-4 sm:mb-6 flex-wrap">
      ...
      {activeSheet !== 'schedule' && activeSheet !== 'progress' && activeSheet !== 'weightlog' && (
        <button
        ...
        >
          ...
          <span className="hidden sm:inline">Export Week {activeWeek}</span>
        </button>
      )}
    </div>
  );
