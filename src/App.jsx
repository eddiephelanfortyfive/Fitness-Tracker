...
const App = () => {
  ...
  const getTodaysWorkouts = () => {
    ...
    const schedule = getScheduleForWeek(effectiveWeek, runningData, cyclingData, weightData, workoutDays, activeLevel);
  ...
  const nextWorkout = getNextWorkout(weekToSearchFrom, maxWeeks, runningData, cyclingData, weightData, workoutDays, activeLevel, todayWeekday, programHasStarted);
  ...
  const handleExportToCSV = () => {
    exportToCSV(activeSheet, effectiveWeek, runningData, cyclingData, weightData, getLastWeekWeight);
  };
